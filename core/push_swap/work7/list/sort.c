...
/*   Updated: 2026/01/18 09:10:26 by melshata         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../push_swap.h"

static int	is_peak(t_list *lst, t_list *node, int type)
{
	t_list	*p;
...
static void	radix_filter(t_pack *pack, int i, int size)
{
	int	j;
